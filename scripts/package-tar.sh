...
install -m 0644 DCHU_ADJUSTMENTS.md "$STAGE/DCHU_ADJUSTMENTS.md"
install -m 0644 LICENSE "$STAGE/LICENSE"
install -m 0644 CONTRIBUTING.md "$STAGE/CONTRIBUTING.md"
install -m 0644 SECURITY.md "$STAGE/SECURITY.md"
install -m 0644 module/Makefile "$STAGE/module/Makefile"
install -m 0644 module/clevo_control_center.c "$STAGE/module/clevo_control_center.c"
